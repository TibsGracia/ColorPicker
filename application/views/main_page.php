        ...
        <div class="col">
          ...
          <div class="card p-3">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Title 1</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Title 2</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Title 3</a>
              </li>
            </ul>
              ...
              <div class="tab-pane fade show active p-2" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="blue lighten-5 p-2">
                  <div id="container">
                    ...
                    <img id="background-image" src="https://lh3.googleusercontent.com/proxy/fJpGyXkG8YiSM698EactWO1geewmv6YIO7uE2_Crdu8ZuWSMcd2pk5o234KlKnTCxVQuphOQDsxvHzjMlyCph525-ls2OqltuMhN" alt="">
                  </div>
                  <div class="colors">
